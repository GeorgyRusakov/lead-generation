...
def-env activate-virtualenv [] {
    ...
    let virtual_env = '/Users/user/pythonProject/pythonProject/PetProect/Lidogeneration/venv'
    let bin = 'bin'
    let path_sep = ':'
...
alias deactivate = source '/Users/user/pythonProject/pythonProject/PetProect/Lidogeneration/venv/bin/deactivate.nu'
